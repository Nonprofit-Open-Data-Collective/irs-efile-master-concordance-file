...
Variable with SB scope occur either in the header or signature block on all of the forms. Since the signature block is in a different location on each form, When variables have SB scope they will always have a location of 00 for consistency across the forms, even though in two cases they are assigned their own part.
